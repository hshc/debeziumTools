...
public class DbzKafkaSrcConnectorMakerVisitor extends SnowCodeGeneratorGenericVisitor {
	private DatabaseConfig databaseConfig;

	public DbzKafkaSrcConnectorMakerVisitor(Map<String, String> typeMapping, String workingDatabase, String sourceSchema, String targetSchema, String dbConf) {
		super(typeMapping, workingDatabase, sourceSchema, null, targetSchema);
        databaseConfig = DatabaseConfig.loadAll(dbConf).getFirst();
	}

	public DbzKafkaSrcConnectorMakerVisitor(Map<String, String> typeMapping, String dbConf) {
