                    ...
                    while (true) {
                        ...
                        switch (choice) {
                            ...
                            case 3:
                                ...
                                String typeMappingFile = scanner.next();
                                System.out.print(Messages.INPUT_OUTPUT_DDL_FILE_PATH);
                                String ddlOutputFile = scanner.next();
                                translateDDL(ddlInputFile, typeMappingFile, ddlOutputFile);
                                break;
                            case 4:
